...
Ignore items from "Quotation Result", "Tender Result", "Quotation Cancellation" or "Tender Cancellation" sections.
Skip any items that have a "Successful Bidders" column - those are historical results.
Source URL: {url}
